...
function scoresAverage(moviesArray) {
    ...
    const sum = moviesArray.reduce((acc, score) => {
    ...
    const averageDec = average.toFixed(2);
...
function dramaMoviesScore(moviesArray) {
    ...
    const scoreSum = dramaMovies.reduce((total, movie) => total + movie.score, 0);
...
function orderAlphabetically(moviesArray) {
    const copiedArray = moviesArray.slice();
